...
func (in *ScaleInSpec) DeepCopyInto(out *ScaleInSpec) {
	*out = *in
	in.ScaleScriptSpec.DeepCopyInto(&out.ScaleScriptSpec)
...
func (in *TrainingJobSpec) DeepCopyInto(out *TrainingJobSpec) {
	*out = *in
	...
	if in.AutoScaleIntervalSeconds != nil {
		in, out := &in.AutoScaleIntervalSeconds, &out.AutoScaleIntervalSeconds
		*out = new(int32)
		**out = **in
	}
	if in.AutoScaleTimeoutSeconds != nil {
		in, out := &in.AutoScaleTimeoutSeconds, &out.AutoScaleTimeoutSeconds
		*out = new(int32)
		**out = **in
	}
}
...
func (in *TrainingJobStatus) DeepCopyInto(out *TrainingJobStatus) {
	*out = *in
	in.JobStatus.DeepCopyInto(&out.JobStatus)
	if in.TargetWorkers != nil {
		in, out := &in.TargetWorkers, &out.TargetWorkers
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
